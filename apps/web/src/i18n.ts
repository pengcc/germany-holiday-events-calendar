...
export const copy = {
  zh: {
    ...
    noStateResultMonths: "当前联邦州、假期类型和时间范围内没有匹配的假期结果。",
    ...
    regionalAdvisoryMarkerLegend: "部分地区适用提示",
  ...
  de: {
    ...
    noStateResultMonths:
      "Für das gewählte Bundesland, die Ferienarten und den Zeitraum gibt es keine passenden Ferientermine.",
    ...
    regionalAdvisoryMarkerLegend: "Hinweis auf regionale Geltung",
